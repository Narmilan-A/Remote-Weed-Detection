...
# Save the figure
plt.tight_layout()
plt.savefig('validation model outcomes/CM_heatmap_subplot_validation.png', bbox_inches='tight', dpi=350)
plt.show()
...
plt.savefig('validation model outcomes/Prediction_validation.png', bbox_inches='tight', dpi=300)
plt.show()
